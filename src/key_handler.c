...
/*   Updated: 2024/09/10 12:56:08 by bde-souz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_player(t_game *game, double move_x, double move_y)
{
	...
	if (game->map[(int)new_move_y][(int)new_move_x] != '1')
	{
...
void	move_up(t_game *game)
{
	...
	if(game->map[(int)(game->pos_x + game->dirx * PLAYER_SPEED)][(int)(game->pos_y)] == '0')
		game->pos_x += game->dirx * PLAYER_SPEED;
	if(game->map[(int)(game->pos_x)][(int)(game->pos_y + game->diry * PLAYER_SPEED)] == '0')
...
void	move_left(t_game *game)
{
	...
	if (game->map[(int)(game->pos_x - move_x)][(int)(game->pos_y)] == '0')
		game->pos_x -= move_x;
	if (game->map[(int)(game->pos_x)][(int)(game->pos_y + move_y)] == '0')
		game->pos_y += move_y;
