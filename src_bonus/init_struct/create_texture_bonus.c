...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   create_texture_bonus.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: bde-souz <bde-souz@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/11 10:55:25 by bde-souz          #+#    #+#             */
/*   Updated: 2024/09/30 15:42:53 by bde-souz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	create_all_textures(t_game *game)
{
	if (create_texture(game, 0, game->map.north_path, "NORTH")
		...
		|| create_texture(game, door, "assets/sprites/door.xpm", "DOOR")
		|| create_texture(game, door_mid, "assets/sprites/door_mid.xpm", \
		"DOOR_MID")
		|| create_texture(game, door_side, "assets/sprites/door_side.xpm", \
			"DOOR_SIDE"))
	{
		ft_quit_game(game);
	}
